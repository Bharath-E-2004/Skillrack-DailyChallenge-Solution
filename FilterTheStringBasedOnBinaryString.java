...
public class Hello {
    public static void main(String[] args) {
        ...
        String str1 = sc.next(); // Input string with characters
        String str2 = sc.next(); // Binary string indicating transformation
...
Where ever 1 occurs in B, if the character is not an alphabet then delete the character.
Else toggle the case of the alphabet. The program must print the revised string value.
...
12Ab5c4P9qRBS0t 111001010111011
