...
public class Hello {
    public static void main(String[] args) {
        ...
        // Generate all non-empty subsets of vehicles
        ...
        for (int mask = 1; mask < totalCombinations; mask++) {
            ...
            passengerCounts.add(sum);
        }

        List<Integer> sortedCounts = new ArrayList<>(passengerCounts);
...
/*
The capacity of N vehicles are passed as the input. The program must print the number of passengers who can travel in such a way that the occupied vehicles are filled to their capacity.

The output containing the number of passengers must be sorted.
...
The second line contains N integer values separated by a space representing the capacity of N
